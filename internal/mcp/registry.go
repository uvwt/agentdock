...
var toolRegistry = []ToolDefinition{
	...
	{Name: "task_manage", Title: "Manage recoverable tasks", Description: "Persist and resume substantial multi-step AgentDock tasks. Prefer continuous execution and one final_review after real work instead of step-by-step evidence logging. Use block or record_attempt only for failures and recovery. Complete with complete_after_review after final_review passes. This tool records state only and never executes commands or other tools.", Destructive: false},
