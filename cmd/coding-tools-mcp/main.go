...
func run() error {
	...
	flag.StringVar(&cfg.AgentDockDir, "agent-dock-dir", cfg.AgentDockDir, "AgentDock control directory; absolute or workspace-relative")
