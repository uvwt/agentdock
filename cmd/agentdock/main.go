...
func run() error {
	...
	flag.StringVar(&cfg.MemoryEndpoint, "recall-endpoint", cfg.MemoryEndpoint, "optional RecallDock HTTP endpoint, for example http://127.0.0.1:18777")
	flag.StringVar(&cfg.MemoryEndpoint, "memory-endpoint", cfg.MemoryEndpoint, "deprecated alias for --recall-endpoint")
	flag.StringVar(&cfg.MemoryToken, "recall-token", cfg.MemoryToken, "optional RecallDock bearer credential")
	flag.StringVar(&cfg.MemoryToken, "memory-token", cfg.MemoryToken, "deprecated alias for --recall-token")
	flag.IntVar(&cfg.MemoryTimeoutMS, "recall-timeout-ms", cfg.MemoryTimeoutMS, "RecallDock HTTP timeout in milliseconds")
	flag.IntVar(&cfg.MemoryTimeoutMS, "memory-timeout-ms", cfg.MemoryTimeoutMS, "deprecated alias for --recall-timeout-ms")
