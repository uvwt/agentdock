...
var toolRegistry = []ToolDefinition{
	...
	{Name: "task_manage", Title: "Manage recoverable tasks", Description: "Persist and resume substantial multi-step AgentDock tasks with a simple create/list/get/block/resume/final_review/complete_after_review flow. This default tool intentionally hides legacy step evidence fields; use task_manage_recovery only for recovery or template maintenance.", Destructive: false},
	{Name: "task_manage_recovery", Title: "Recover or maintain task state", Description: "Advanced task state operations for recovery, legacy step evidence, phase checkpoints, and workflow template maintenance. Prefer task_manage for normal work.", Destructive: false},
	...
	{Name: "recall_search", Title: "Search RecallDock", Description: "Search RecallDock memories, cards, and notes. Use kind=all, markdown, card, or note; backend handles internal routing such as prefix and scope.", ReadOnly: true, OpenWorld: true},
	...
	{Name: "recall_write", Title: "Write RecallDock entry", Description: "Plan, write, patch, update facts, or delete RecallDock content. The model must choose kind=card, note, markdown, patch, fact, delete, or explicit auto for a non-writing plan.", Destructive: false, OpenWorld: true},
