...
func (s *Service) gitHubRepoAccess(ctx context.Context, args map[string]any) (Result, error) {
	...
	token, username, err := githubCredential(s.ws.Root())
	if err != nil {
...
func DiagnoseOutput(output string) map[string]any {
