...
var toolRegistry = []ToolDefinition{
	...
	{Name: "private_notes_write", Title: "Write private note", Description: "Write a plaintext private note under private-notes/notes and always generate a mandatory encrypted backup under private-notes/encrypted. Do not use recall_write for private material.", Destructive: false, OpenWorld: true},
	{Name: "private_notes_maintain", Title: "Maintain private notes", Description: "Initialize, list, check, or sync encrypted backups for the private-notes store. Encrypted backups are mandatory for every plaintext note.", Destructive: false, OpenWorld: true},
