...
func allToolSpecs() []ToolSpec {
	...
	return []ToolSpec{
		...
		{Name: "workspace_edit", Title: "Edit workspace", Description: "Edit workspace files through one action-based entrypoint: replace, patch, add, delete, or move. Legacy apply_patch/edit_file wrappers return replacement_tool metadata.", Profiles: unifiedProfiles(), Handler: ctxToolHandler((*Runtime).workspaceEdit)},
