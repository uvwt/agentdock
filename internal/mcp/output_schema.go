...
func outputSchema(name string) map[string]any {
	...
	case "task_manage", "task_manage_recovery":
		...
		props["task_summary"] = objectProp("Compact task summary returned by create, final_review, complete_after_review, record_attempt, and task state mutation actions.")
		props["next_required_action"] = stringProp("Concise guidance for the next real non-task action or final review step.")
