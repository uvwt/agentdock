...
var toolRegistry = []ToolDefinition{
	...
	{Name: "desktop_clipboard_set", Title: "Set desktop clipboard", Description: "Set the macOS clipboard text using pbcopy.", Destructive: false},
	...
	{Name: "desktop_click", Title: "Desktop click", Description: "Click a macOS desktop coordinate using cliclick. Experimental and permission-sensitive.", Destructive: false},
	{Name: "desktop_double_click", Title: "Desktop double click", Description: "Double-click a macOS desktop coordinate using cliclick.", Destructive: false},
	{Name: "desktop_scroll", Title: "Desktop scroll", Description: "Scroll the macOS desktop using cliclick.", Destructive: false},
	{Name: "desktop_drag", Title: "Desktop drag", Description: "Drag from one macOS desktop coordinate to another using cliclick.", Destructive: false},
	{Name: "desktop_type", Title: "Desktop type text", Description: "Type text into the focused macOS app using cliclick. Experimental and permission-sensitive.", Destructive: false},
	{Name: "desktop_hotkey", Title: "Desktop hotkey", Description: "Send a keyboard shortcut to the focused macOS app using cliclick. Experimental and permission-sensitive.", Destructive: false},
