...
var toolRegistry = []ToolDefinition{
	...
	{Name: "notes_search", Title: "Search notes", Description: "Search notes with an index-first strategy over notes/questions or notes/github-learning, then fall back to MemoryDock search.", ReadOnly: true, OpenWorld: true},
