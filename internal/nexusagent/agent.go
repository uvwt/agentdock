...
func envDefinitions(state *skillstate.Store) []envregistry.Definition {
	...
	for _, def := range []envregistry.Definition{
		...
		{Skill: "spotify-web-api", Name: "SPOTIFY_ACCESS_TOKEN", Kind: envregistry.KindSecret, Source: "compat"},
		{Skill: "spotify-web-api", Name: "SPOTIFY_CLIENT_ID", Kind: envregistry.KindPlain, Source: "compat"},
		{Skill: "spotify-web-api", Name: "SPOTIFY_EXPIRES_AT", Kind: envregistry.KindPlain, Source: "compat"},
		{Skill: "spotify-web-api", Name: "SPOTIFY_REDIRECT_URI", Kind: envregistry.KindPlain, Source: "compat"},
		{Skill: "spotify-web-api", Name: "SPOTIFY_REFRESH_TOKEN", Kind: envregistry.KindSecret, Source: "compat"},
