...
func (r *Runtime) callWSLFileHelper(ctx context.Context, selection fileRuntimeSelection, request map[string]any) (Result, error) {
...
func (r *Runtime) readFileWSL(ctx context.Context, args map[string]any, selection fileRuntimeSelection) (Result, error) {
	...
	loaded, err := r.callWSLFileHelper(ctx, selection, map[string]any{"action": "read", "path": path})
	if err != nil {
		return nil, err
	}
...
func (r *Runtime) listDirWSL(ctx context.Context, args map[string]any, selection fileRuntimeSelection) (Result, error) {
	path, err := resolveWSLFilePath(stringArg(args, "path", ""))
	if err != nil {
		return nil, err
	}
	return r.callWSLFileHelper(ctx, selection, map[string]any{
		"action":          "list_dir",
		"path":            path,
...
func (r *Runtime) listFilesWSL(ctx context.Context, args map[string]any, selection fileRuntimeSelection) (Result, error) {
	path, err := resolveWSLFilePath(stringArg(args, "path", ""))
	if err != nil {
		return nil, err
	}
...
func (r *Runtime) searchTextWSL(ctx context.Context, args map[string]any, selection fileRuntimeSelection) (Result, error) {
