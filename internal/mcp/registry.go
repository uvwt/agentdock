...
var toolRegistry = []ToolDefinition{
	...
	{Name: "context_list", Title: "List context", Description: "List AgentDock context files under the configured context directory.", ReadOnly: true},
	{Name: "context_read", Title: "Read context", Description: "Read a UTF-8 Markdown context file with parsed frontmatter.", ReadOnly: true},
	{Name: "context_search", Title: "Search context", Description: "Search AgentDock context files by text and path.", ReadOnly: true},
	{Name: "context_pack", Title: "Pack project context", Description: "Return a compact bundle of shared profile, project overview, conventions, decisions, runbooks, and handoff context.", ReadOnly: true},
	{Name: "context_append_note", Title: "Append context note", Description: "Append a Markdown note into the context inbox or another scoped context area.", Destructive: false},
	{Name: "context_write", Title: "Write context", Description: "Write a Markdown context file; writing outside inbox requires confirmed=true.", Destructive: false},
	...
	{Name: "memory_sync_pull", Title: "MemoryDock sync pull", Description: "Ask MemoryDock to pull memory updates from Git.", Destructive: false, OpenWorld: true},
	{Name: "memory_sync_push", Title: "MemoryDock sync push", Description: "Ask MemoryDock to commit and push pending memory updates to Git.", Destructive: false, OpenWorld: true},
	{Name: "memory_sync_now", Title: "MemoryDock sync now", Description: "Ask MemoryDock to run pull then push immediately.", Destructive: false, OpenWorld: true},
