...
func outputSchema(name string) map[string]any {
	...
	case "task_manage":
		...
		props["vector_search_enabled"] = boolProp("Whether optional embedding-backed template vector search is enabled for template_match.")
		props["workflow_dir"] = stringProp("Local AgentDock workflow template directory, returned by template_match.")
		props["vector_search_enabled"] = boolProp("Whether optional embedding-backed template vector search is enabled for template_match.")
	...
	case "recall_write":
		...
		props["selected_kind"] = stringProp("Selected concrete target/action when recall target=auto action=plan.")
		props["auto_plan"] = objectProp("Reviewable plan and next_call when target=auto action=plan.")
	...
	case "browser_session":
		...
		props["profile_action"] = stringProp("Profile action performed for profile_* actions.")
		props["site"] = stringProp("Named site profile for profile_* actions.")
		props["profile_id"] = stringProp("Persistent browser profile id for profile_* actions.")
