...
func (r *Runtime) Call(ctx context.Context, name string, args map[string]any) (Result, error) {
	...
	case "context_list":
		return r.contextList(args)
	case "context_read":
		return r.contextRead(args)
	case "context_search":
		return r.contextSearch(args)
	case "context_pack":
		return r.contextPack(args)
	case "context_append_note":
		return r.contextAppendNote(args)
	case "context_write":
		return r.contextWrite(args)
	case "memory_list":
	...
	case "memory_sync_pull":
		return r.memorySyncPull(ctx, args)
	case "memory_sync_push":
		return r.memorySyncPush(ctx, args)
	case "memory_sync_now":
		return r.memorySyncNow(ctx, args)
